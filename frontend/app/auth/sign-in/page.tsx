      ...
      <div className="flex items-center justify-center p-8 bg-zinc-950 text-white">
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-white/5 border-white/10 text-white focus:border-cyan-500 focus:bg-white/[0.08]"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="remember" className="text-sm font-normal cursor-pointer text-zinc-400">
                  Remember for 30 days
                </Label>
              </div>
              <a href="#" className="text-sm text-cyan-400 hover:underline font-medium cursor-pointer">
                Forgot password?
              </a>
            </div>
          ...
          <div className="mt-6">
            <Button 
              variant="outline" 
              className="w-full h-12 bg-white/5 border-white/10 hover:bg-white/10 text-white cursor-pointer transition-all"
              type="button"
              onClick={handleGoogleSignIn}
            >
              <Mail className="mr-2 size-5 text-cyan-400" />
              Log in with Google
            </Button>
          </div>
