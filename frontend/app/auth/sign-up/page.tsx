...
export default function SignUpPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check if verification is needed (otp sent)
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-black">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-zinc-900 via-zinc-950 to-black p-12 text-white border-r border-white/10 overflow-hidden">
        <div className="relative z-20">
          <Link href="/" className="flex items-center gap-2 text-lg font-semibold cursor-pointer">
            ...
            <span className="font-bold tracking-wide">TWINFOLIO</span>
          </Link>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-zinc-950 text-white">
        <div className="w-full max-w-[420px]">
          ...
          <div className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-12">
            ...
            <span className="font-bold">TWINFOLIO</span>
          </div>

          {step === "register" ? (
            <>
              <div className="text-center mb-10">
                <h1 className="text-3xl font-bold tracking-tight mb-2">Create new account</h1>
                <p className="text-zinc-400 text-sm">Please fill in your details below</p>
              </div>
              ...
              <form onSubmit={handleRegister} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="h-12 bg-white/5 border-white/10 text-white focus:border-cyan-500"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      required
                      className="h-12 pr-10 bg-white/5 border-white/10 text-white focus:border-cyan-500"
                    />
                    <button
                      type="button"
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-base font-medium bg-white text-black hover:bg-zinc-200 cursor-pointer shadow-lg transition-all active:scale-[0.98]" 
                  size="lg" 
                  disabled={isLoading}
                >
              ...
              <div className="text-center text-sm text-zinc-400 mt-8">
                ...
                <Link href="/auth/sign-in" className="text-white font-medium hover:underline cursor-pointer">
                  Log in
                </Link>
              </div>
            </>
            ...
            <>
              <div className="text-center mb-10">
                ...
                <p className="text-zinc-400 text-sm">Enter the code sent to {email}</p>
              </div>

              <form onSubmit={handleVerify} className="space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="code" className="text-sm font-medium text-zinc-300">Verification Code</Label>
                  <Input
                    id="code"
                    type="text"
                    ...
                    required
                    className="h-12 bg-white/5 border-white/10 text-white focus:border-cyan-500 text-center tracking-widest text-lg font-bold"
                  />
                </div>

                {message && (
                  <div className="p-3 text-sm text-cyan-400 bg-cyan-950/20 border border-cyan-900/30 rounded-lg text-center">
                    {message}
                  </div>
                )}
                ...
                <button
                  ...
                  className="w-full text-center text-sm text-cyan-400 hover:underline cursor-pointer mt-4"
                >
