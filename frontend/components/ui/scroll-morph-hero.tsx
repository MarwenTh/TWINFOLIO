    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Back Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-zinc-900 flex flex-col items-center justify-center p-4 border border-zinc-750"
...
// Unsplash Images representing portfolios, designs, tech, code
const IMAGES = [
...
export default function IntroAnimation() {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-[550px] bg-zinc-950 overflow-hidden border border-white/5 rounded-2xl md:rounded-[2rem] shadow-2xl">
            {/* Container */}
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    >
                        Portfolios built with TWINFOLIO.
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={introPhase === "circle" && morphValue < 0.5 ? { opacity: 0.5 - morphValue } : { opacity: 0 }}
                        transition={{ duration: 1, delay: 0.2 }}
                        className="mt-4 text-xs font-bold tracking-[0.2em] text-cyan-400"
                    >
                        SCROLL OVER THIS PANEL TO EXPLORE
                    </motion.p>
                </div>
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-zinc-400 max-w-lg leading-relaxed">
                        TWINFOLIO aggregates projects, code repositories, and work history <br className="hidden md:block" />
                        into interactive cards that visitors can explore and chat with.
                    </p>
                </motion.div>
